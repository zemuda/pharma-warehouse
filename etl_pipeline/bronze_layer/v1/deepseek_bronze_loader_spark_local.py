...
class BronzeLayerSparkLoader:
    def __init__(
        ...
        source_data_path: str = "/opt/etl/data/output",  # Local input path
    ):
    ...
    def discover_parquet_files(self, feature: str) -> List[Path]:
        ...
        feature_path = Path(self.source_data_path) / feature
    ...
    def get_table_name_from_path(self, file_path: Path) -> str:
        ...
        try:
            # Convert to relative path from input base
            relative_path = file_path.relative_to(Path(self.source_data_path))
    ...
    def load_file_incrementally(
        ...
        try:
            ...
            feature = file_path.relative_to(Path(self.source_data_path)).parts[0]
    ...
    def load_feature_incrementally(self, feature: str) -> Dict:
        ...
        operation_data = {
            ...
            "load_path": f"{self.source_data_path}/{feature}",
...
def run_bronze_local():
    ...
    try:
        ...
        loader = BronzeLayerSparkLoader(
            ...
            source_data_path="/opt/etl/data/output",
        )
