...
INPUT_DIR=./excel_pipeline/data/input
OUTPUT_DIR=./excel_pipeline/data/output
STATE_FILE=./excel_pipeline/state/processing_state.json
...
def run_pipeline():
    ...
    config = {
        'input_dir': os.getenv('INPUT_DIR', './excel_pipeline/data/input'),
        'output_dir': os.getenv('OUTPUT_DIR', './excel_pipeline/data/output'),
        'state_file': os.getenv('STATE_FILE', './excel_pipeline/state/processing_state.json'),
