...
WATCH_DIR=./excel_pipeline/data/input
...
python excel_parquet_pipeline.py \
  --input-dir ./excel_pipeline/data/input \
  --output-dir ./excel_pipeline/data/output \
  --state-file ./excel_pipeline/state/processing_state.json \
  --log-level INFO
...
export WATCH_DIR=./excel_pipeline/data/input
...
services:
  ...
  pipeline:
    ...
    volumes:
      - ./excel_pipeline/data/input:/app/data/input
      - ./excel_pipeline/data/output:/app/data/output
...
cp /path/to/your/excel/files/*.xlsx ./excel_pipeline/data/input/
...
cp /path/to/new/excel/file.xlsx ./excel_pipeline/data/input/
...
rm -f excel_pipeline/state/processing_state.json
rm -f *.log
```
...
4. **File Watcher Not Detecting Files**
   ...
   ls -la ./excel_pipeline/data/input/
   ```
